                       ...
                       int stride_w, Container *output)
{
    ...
    my_max_pool_h<<<grid_size, BLOCK_SIZE>>>(
...
__global__ void my_d_max_pool_h(
                         ...
                         Container *inputs_grad)
{
    ...
    my_d_max_pool_h<<<grid_size, BLOCK_SIZE>>>(
...
void MaxPool::forward()
{
    ...
    my_max_pool(input, this->mask.get(), this->kernel_h, this->kernel_w,
...
void MaxPool::backward()
{
    ...
    my_d_max_pool(output_grad, input, this->mask.get(), this->kernel_h,
